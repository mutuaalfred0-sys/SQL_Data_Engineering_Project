...
-- Stage jobs that are remote before aggregating to determine the remote median salary per job
SELECT 
    job_title_short,
...
-- Scenarion 3 - subquery in `HAVING`
...
-- Use a CTE to calculate the median salry by title and work arrangement, the compare those medians.
